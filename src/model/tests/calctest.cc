...
TEST(calc_test, t6) {
  Calculator m("tan(6.08123 /log(   5.6321 + 345 * (-x) *(-13.111))   ) /ln(45.32 / "
      "(+99.1334)   )^(+2)");
  double result = 0.0, expected = 0.0;
...
TEST(calc_test, t7) {
  Calculator m("asin(0.256) * acos(-0.3456) / atan(0.000023456) + (2345.667 ^ (0.5) - "
      "12.3)");
  double result = 0.0, expected = 0.0;
  result = m.CalculateExpression(0.0);
...
TEST(calc_test, t9) {
  Calculator m("555.666 mod 3.456 + ( ( atan(0.9876/x) + (-asin(0.222)  )  )  * cos((x "
...
TEST(calc_test, t10) {
  Calculator m("-1678.2322 * x +  sqrt( log  (38.38 /24.55 ) + ln(58.2 - (-300.4))) * x "
      "* x * (-x)");
  double result = 0.0, expected = 0.0;
...
TEST(calc_test, t11) {
  Calculator m("678.987 * sin ( 23.2 -  6.7 +  sin(x *   x) -9.789 * cos(22.37/2.32)) + "
...
TEST(calc_test, t12) {
  Calculator m("-(-87.543*sin(0.999+tan(x)-2.234))-50.66*(acos(0.234)/atan(0.55))");
  double result = 0.0, expected = 0.0;
