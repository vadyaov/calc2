...
struct Amount {
  ...
  Amount(double dep, double rep, double rem)
      : dep_amount{dep}, rep_amount{rep}, rem_amount{rem} {}

  Amount(const Amount& other)
      : dep_amount{other.dep_amount},
...
struct Rate {
  ...
  Rate(const Rate& other)
      : dep_rate{other.dep_rate}, tax_rate{other.tax_rate} {}
};
